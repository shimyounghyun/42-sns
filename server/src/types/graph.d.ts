...
export interface AddDateMutationArgs {
  startAt: string;
  endAt: string;
}
...
export interface AddDateResponse {
  result: boolean;
  error: string | null;
}
